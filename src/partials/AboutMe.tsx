    ...
    <section className='santiago_section mb-12 xl:mb-0'>
      <div className="santiago_container items-center xl:grid gap-4 grid-cols-5">
        <Image
          ...
          className="santiago_picture col-span-2 rounded-xl mb-12 xl:mb-12 mx-auto w-full shadow-xl transition-all duration-300"
          width={400}
          height={800}
          priority
        />
        <div className="santiago_content col-span-3 xl:ml-4">
          ...
          <p>
            <span>
              I am a <span className="text-rose-900 font-bold">FrontEnd Developer</span> with experience in high-demand web projects,
              standing out for quickly integrating into multidisciplinary teams,
              generating positive impact with <span className="text-rose-900 font-bold">accurate analysis and efficient solutions</span>.
            </span>
            <br/>
            <br/>
            <span>
              I have <span className="text-rose-900 font-bold">led successful projects</span>, facilitating communication between clients and development teams.
