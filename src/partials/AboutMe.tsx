    ...
    <FullSection>
      <div className="santiago_container items-center xl:grid gap-4 grid-cols-5">
        <Image
          ...
          className="santiago_picture col-span-2 rounded-xl mb-12 xl:mb-12 mx-auto w-full shadow-xl  xl:hover:shadow-lg xl:hover:shadow-neutral-500 transition-all duration-300"
          width={400}
          height={800}
          priority
        />
