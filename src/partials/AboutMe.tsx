...
const AboutSantiago = () => {
  return (
    <FullSection>
      <div className="santiago_container grid-cols-5 items-center gap-4 xl:grid" data-scroll-section>
        <Image
          src={`/image/santiago-pic-1.png`}
          alt="Santiago Picture"
          className="santiago_picture col-span-2 mx-auto mb-12 w-full rounded-xl shadow-xl transition-all duration-300 xl:mb-12 xl:hover:shadow-lg xl:hover:shadow-neutral-500"
          width={400}
          height={800}
          priority
        />
