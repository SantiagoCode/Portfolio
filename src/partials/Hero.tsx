	...
	return (
		<>
			...
			<div id='Hero' className='relative mb-12 flex min-h-screen flex-col items-center justify-center overflow-hidden px-4'>
				...
				<CardContainer
					id={'Hero_Stack'}
					className="inter-var before:absolute before:h-full before:w-full before:rounded-full before:bg-[rgb(255,255,255,0.1)] before:hover:bg-[rgb(255,255,255,0.3)] before:transition-all before:duration-300 transition-all before:backdrop-blur-xl before:content-[''] before:border">
